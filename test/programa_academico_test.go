...
func run_bee() {
	parametros := "PROGRAMA_ACADEMICO_HTTP_PORT=" + beego.AppConfig.String("httpport") + " PROGRAMA_ACADEMICO_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " PROGRAMA_ACADEMICO_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " PROGRAMA_ACADEMICO_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " PROGRAMA_ACADEMICO_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " PROGRAMA_ACADEMICO_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
