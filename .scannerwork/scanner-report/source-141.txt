...
type NivelFormacionController struct {
	beego.Controller
}

func (c *NivelFormacionController) URLMapping() {
...
func (c *NivelFormacionController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNivelFormacion(&v); err == nil {
...
// @router /:id [get]
func (c *NivelFormacionController) GetOne() {
...
// @router /:id [put]
func (c *NivelFormacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
